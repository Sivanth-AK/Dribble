...
<section class="bg-light py-5 text-center">
    <div class="container">
        ...
        <p class="lead">
            Explore millions of creative designs from talented designers.
        </p>
...
<section class="bg-primary text-white text-center py-5 mt-5">
    ...
    <div class="container">
        <h2>Join Millions of Designers Today</h2>
        <p>Share your work and get discovered worldwide.</p>
...
<footer class="bg-dark text-white text-center p-4 mt-5">
    ...
    <h5>Powered by Sivanth T</h5>

    <p>
        Dribbble Clone using Bootstrap and Django
    </p>
